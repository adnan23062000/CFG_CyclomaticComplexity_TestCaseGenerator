...
public class MakeGraph {
    ...
    public void start() throws IOException{
        ...
        System.out.println("The code has:\n\n" + calc.calculate(Lines));
    ...
    public void printGraph (){
        ...
        System.out.println("\n\nNo. of Edges in CFG: "+(edgeCount));

        System.out.println("No. of Vertices in CFG: "+vertexCount);

        int compCFG=vertexCount-edgeCount+2;
        System.out.println("\n\nCyclometic complexity = (No. of Vertices) - (No. of Edges) + 2\nCyclomatic Complexity: "+compCFG + "\n\n");
    }
